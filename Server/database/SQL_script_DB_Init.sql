...
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (, 'BeurkLigneGauche', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (, 'BeurkLigneDroite', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (DEFAULT, 'BeurkLigneCourte', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (DEFAULT, 'PiedDuSaule', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (DEFAULT, 'Prevert', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (DEFAULT, 'Olivier', NULL);
INSERT INTO `mydb`.`Restaurant` (`PK_idRestaurant`, `name`, `theme`) VALUES (DEFAULT, 'Grillon', NULL);
